...
import * as colorTool from 'zrender/src/svg-legacy/tool/color';
import * as pathTool from 'zrender/src/svg-legacy/tool/path';
import {parseSVG} from 'zrender/src/svg-legacy/tool/parseSVG';

import * as morphPathTool from 'zrender/src/svg-legacy/tool/morphPath';
